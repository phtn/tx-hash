...
// import { DetailStory } from './_components/detail-story'
// import { EmbeddedDetail } from './_components/embedded-detail'
// import { FlowListColumn, type FlowNode } from './_components/flow'
...
//   return (
//     <div className='flex h-full min-w-0 bg-[#010101]'>
//       <div className='flex min-w-0 flex-1 xl:hidden'>
//         <section className='flex min-w-0 flex-1 flex-col bg-[#050505]'>
//           <div className='border-b border-white/10 px-5 py-4'>
//             <p className='font-mono text-[10px] uppercase tracking-[0.34em] text-white/34'>Workspace</p>
//             <h2 className='mt-2 text-[1.45rem] font-medium leading-none tracking-[-0.05em] text-white'>{tab.label}</h2>
//             <p className='mt-3 text-sm leading-6 text-white/54'>{tab.description}</p>
//           </div>
...
//       className='relative flex h-full min-w-0 w-full overflow-hidden'>
//       <nav className='flex h-full w-20 min-w-20 border-r border-white/10 bg-[#020202]/96 xl:w-[20rem] xl:min-w-[20rem]'>
//         <Tabs.List aria-label='account actions' className='flex w-full flex-col gap-2 overflow-y-auto p-2 xl:p-4'>
//           {ACTION_TABS.map((tab) => {
...
//                 value={tab.id}
//                 className={cn(
//                   'flex w-full items-center justify-center gap-4 rounded-[24px] border px-3 py-3 text-left transition-all duration-200 xl:justify-start xl:px-4 xl:py-4',
//                   isActive
//                     ? 'border-white/15 bg-white/[0.08] text-white shadow-[0_18px_50px_rgba(24,18,15,0.18)]'
//                     : 'border-transparent bg-transparent text-white/72 hover:border-white/10 hover:bg-white/[0.04] hover:text-white'
//                 )}>
//                 <div
//                   className={cn(
//                     'flex h-11 w-11 shrink-0 items-center justify-center rounded-full',
//                     isActive ? 'bg-[#ff7d33]/12' : 'bg-white/[0.04]'
//                   )}>
//                   <Icon name={tab.icon} className={cn('size-5', isActive ? 'text-[#ff8a46]' : 'text-white/74')} />
//                 </div>

//                 <div className='hidden min-w-0 xl:block'>
//                   <p className={cn('font-ct text-lg font-medium tracking-[-0.03em]', isActive && 'text-white')}>
//                     {tab.label}
//                   </p>
//                   <p className={cn('mt-1 text-sm leading-5', isActive ? 'text-white/60' : 'text-white/44')}>
//                     {tab.description}
//                   </p>
//                 </div>
//               </Tabs.Tab>
...
//       {ACTION_TABS.map((tab) => (
//         <Tabs.Panel key={tab.id} value={tab.id} className='min-w-0 flex-1 overflow-hidden'>
//           <ActionTabFlow
//             tab={tab}
