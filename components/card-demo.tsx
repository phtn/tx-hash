        ...
        <div className='col-span-12 grid grid-cols-12 gap-4'>
          ...
          <div className='col-span-12 grid grid-cols-12 gap-4 lg:col-span-6'>
            ...
            <Card className='col-span-12'>
              ...
              <Card.Header className='gap-3'>
                <Icon name='arrow-right' aria-label='Dollar sign icon' className='text-primary size-4 shrink-0' />
                <div className='flex flex-col gap-1'>
                  <span className='text-xs font-medium text-muted uppercase'>PAYMENT</span>
                  <Card.Title className='pr-8 text-sm sm:text-base'>You can now withdraw on crypto</Card.Title>
          ...
          <Card className='col-span-12 min-h-[200px] overflow-hidden rounded-3xl lg:col-span-6'>
            ...
            <Card.Header className='z-10 text-white'>
              ...
              <Card.Description className='text-sm leading-5 font-medium text-black/50'>Home Robot</Card.Description>
            </Card.Header>
