      ...
      <div className='relative px-4 py-6'>
        <div className='flex flex-col items-center justify-center gap-4'>
          <motion.div
            ...
            <Icon name='money-send' className='w-6 h-6 text-rose-300' />
          </motion.div>
      ...
      <div className='relative px-4 py-6'>
        <div className='flex flex-col items-center justify-center gap-4'>
          <motion.div
            ...
            <Icon name='box-checked' className='w-6 h-6 text-emerald-400' />
          </motion.div>
          <div className='text-center space-y-1'>
...
export const SendTab = ({
  ...
  const _txHash = selectedToken === 'usdc' ? usdcHash : selectedToken === 'usdt' ? usdtHash : _hash
  const receipt =
    selectedToken === 'usdc'
      ? usdcReceipt
        ? {
    ...
    <motion.div
      ...
      {hasInsufficientBalance && (
        <motion.div
          ...
          <Icon name='dots-fill' className='w-4 h-4 text-red-400 shrink-0' />
          ...
          <button
            ...
            {isPending || isConfirming ? (
              <motion.div animate={{ x: [0, 10, 0] }} transition={{ duration: 0.5, repeat: Infinity }}>
                <Icon name='money-send' className='w-5 h-5' />
              </motion.div>
            ) : (
